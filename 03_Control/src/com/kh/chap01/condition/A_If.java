...
public class A_If {
	 ...
	 * 단, 이 순차적인 흐름을 바꾸고자 한다면 제어문 이라는걸 이용하여 직접 제어 가능
	 * 
	 ...
	 * 
	 * * 조건문
	 * 	 "조건식"을 통해 참이나 거짓이냘르 판단해서 참일 경우 그에 해당하는 코드 실행
	 * 
	...
	public void method1() {
		 ...
		 * => 조건식이 거짓(false)일 경우 => 중광호 블럭 안의 코드 무시하고 넘어감
		 */
	...
	public void method6() {
		...
		*/
		...
		// String은 무조건 초기화! // 참조자료형과 동등비교시 equals()사용!!
