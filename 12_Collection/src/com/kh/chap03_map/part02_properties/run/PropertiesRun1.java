...
public class PropertiesRun1 {
	...
	public static void main(String[] args) {
		...
		// 하지만 Properties 사용하는 경우 주로 Properties 담긴 것들을 파일로 출력 또는 입력 받아 올때 사용함.
		...
		*/
		...
		System.out.println(prop); // 저장 순서 유지 안됌, key값 중복시 덮어 씌여짐
		...
		try {
			// 3. store(OutputStream os, String comments) : Properties에 담겨있는 key-value 값을 파일로 출력
			prop.store(new FileOutputStream("test.properties"), "properties Test");
