...
public class E_Logical {
	...
	public void method1() {
		...
		boolean result = (num >= 1) && (num <= 100); // num 값이 1이상 "이고" "그리고" num값이 100 이하일 경우
		// && 의미 : ~이고, 그리고, ~하면서
	...
	public void method3() {
		...
		// 성별을 입력해주세요 (M / F) : gender 라는 변수 선언해서 입력 받아보기
	...
	public void method4() {
		...
		/*
		 *  && : 두개의 조건이 모두 true여야 결과값이 true임. (AND == ~이고, 그리고, ~이면서)
		 *  
		 *  true && ture    => true
		 *  true && false   => false
		 *  false && true   => false
		 ...
		 *   false || false => false
		 *   
		 *   ** || 연산자 기준으로 앞의 결과가 true일 경우 뒤의 조건은 굳이 실행하지 않는다!! **
		 */
	...
	public void method5() {
		...
		// 사용자가 입력한 값이 y 또는 Y입니까? (true, false 중에 하나가 뜨도록) => result
