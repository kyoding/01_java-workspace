...
public class B_InDecrease {
	...
	public void method1() {
		...
		System.out.println("1회 수행 후 결과 : " + num2++); //num2 = 10 출력 => num2 = 11로 증가
		System.out.println("2회 수행 후 결과 : " + num2++); //num2 = 11 출력 => num2 = 12로 증가
		System.out.println("3회 수행 후 결과 : " + num2++); //num2 = 12 출력 => num2 = 13으로 증가
