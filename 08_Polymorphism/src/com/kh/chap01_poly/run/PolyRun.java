...
public class PolyRun {
	...
	public static void main(String[] args) {
		...
		// 기억해둘것!! '=' 기준으로 해서 왼쪽과 오른쪽의 자료형(타입)은 같아야됌!!
		...
		Parent p2 = /*(Parent)*/new Child1(); // 자료형이 다른데 왜 에러가 안뜰까 => 자동형변환 된거임.
		p2.printParent();
		//p2.printChild1();
		...
		// ((Child1)arr[2]).printChild1(); java.lang.ClassCastException : 부적절한 형변환
		...
		/*
		 * 동적바인딩 : 프로그램이 실행되기전에는 컴파일이 되면서 정적바인딩 (레퍼런스 타입의 메소드를 가리킴)
		 * 			 단, 실질적으로 참조하는 자식클래스에 해당메소드가 오버라이딩이 되어있다면
