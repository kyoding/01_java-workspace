...
public class B_ArrayCopy {
	...
	public void method3() {
		//2. 새로운 배열 생성 후 System이라는 클래스에서의 arraycopy() 메소드를 이용한 복사
		int[] origin = {1,2,3,4,5};
		int[] copy = new int[10]; // 넉넉하게 크게 생성 / 0~9 인덱스까지 0이 다 담겨있을 것!!
		
		//System.arraycopy(원본배열명, 복사를 시작할 인덱스, 복사본배열명, 복사본 배열의 복사될 시작인덱스, 복사할 갯수)
	...
	public void method4() {
		 ...
		 * => 단, 내가 제시한 길이가 원본배열의 크기보다 클 경우 기존의 배열에 있는값은 다 복사 나머지는 0으로 채운다.
	 ...
	 * java.lang.String
	 * java.lang.System
	 * java.lang 패키지에 있는 클래스들을 쓸때는 import 안해줘도됌.
	 * 
	 * java.util.Scanner
	 * java.util.Arrays
