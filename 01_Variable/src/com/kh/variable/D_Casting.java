...
public class D_Casting {
	 ...
	 *  
	 *  * 형변환 종류
	 *  1. 자동 형변환 => 자동으로 형 변환이 이뤄져서 우리가 형 변환을 시킬 필요가 없음!!
	...
	public void autoCasting() {
		/*
		 * 자동형변환
		 * 값의 범위가 작은 자료형과 큰 자료형 간의 연산시 자동으로 범위가 작은 자료형을 큰 자료형으로 변환 후 처리해줌
		 * 
		 */
		...
		// float형이 실수형이기 때문에 long형 보다 표현 가능한 수의 범위가 더 커서 자동 형변환이 된다.
		...
		// char변수는 음수값 저장 불가!! => 값의 범위 0~65535
	...
	public void forceCasting() {
		...
		// int iSum = iNum + dNum; // 덧셈연산시 자동 형변환이 된다. => 더블형으로
