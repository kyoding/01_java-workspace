...
public class B_CheckedException {
	...
	public void method2() throws IOException {
		//Scanner 와 같이 키보드로 값을 입력받을 수 있는 객체
		//스캐너 이전의 방식 => 정수, 실수 안됌 무조건 문자만 받을 수 있음
		...
		*/
		...
		// 2. throws : 지금 이자리에서 예외를 처리하지 않고 현재 이 메소드를 호출하는 곳으로 예외처리 떠넘기겠다.(위임)
	 ...
	 *   CheckedException		RuntimeException 외		컴파일에러(빨간줄)		필수(조건문 안됌!! 무조건 예외처리 구문으로)
	 * 
	 * 
	 */
